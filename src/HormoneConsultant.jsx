...
const QUICK_TOPICS = [
  ...
  { label: "Dutasteride for hair loss — what does the evidence say?", icon: "💊" },
  ...
  { label: "Oral vs transdermal HRT — what's the difference?", icon: "🔄" },
  { label: "PCOS and androgen excess — how does it work?", icon: "🧬" },
  { label: "Progesterone sensitivity — what can I do?", icon: "😔" },
  { label: "7 Pillars of Health — where do I start?", icon: "🏛️" },
];

const ALGORITHM_STEPS = [
  {
    step: "01", title: "7 Pillars Foundation", subtitle: "Non-negotiable before medications",
    color: "#059669", bg: "#f0fdf4", border: "#bbf7d0",
    items: [
      "Exercise — resistance training (non-negotiable) + cardiovascular",
      "Diet — protein-forward ≥1.2–1.6g/kg, anti-inflammatory, low processed sugar",
      "Sleep — 7-9 hrs quality sleep; address vasomotor symptoms if disrupting sleep",
      "Stress management — cortisol dysregulation worsens every hormonal imbalance",
      "Social connection — loneliness elevates cortisol chronically",
      "Sunlight — vitamin D3, circadian rhythm, mood regulation",
      "Spirit / purpose — psychological wellbeing directly impacts hormone signaling"
    ],
    note: "[Verified] These 7 pillars are more powerful than any medication or supplement — always address first"
  },
  {
    step: "02", title: "Comprehensive Labs", subtitle: "Baseline before any intervention",
    color: "#1d4ed8", bg: "#eff6ff", border: "#bfdbfe",
    items: [
      "Tier 1 Hormones: Total T + SHBG → Free T (Vermeulen), DHEA-S, DHT, E2, Progesterone, LH, FSH",
      "Tier 2 Metabolic: Fasting insulin (flag >7), Fasting glucose (flag >100), HbA1c, hs-CRP, ApoB lipid panel, ALT",
      "Tier 3 Thyroid: TSH, Free T3, Free T4 ± reverse T3, thyroid antibodies",
      "Body Composition: DEXA scan (lean mass, fat mass, visceral fat, bone density)",
      "DHEA-S Decision Rule: >200 → start E+P first, add T later; <150 → consider all three simultaneously",
      "Free T:E2 Target Ratio: Free T should be ~2–3× lower than E2 (same units); >4–5× = estrogen dominant",
      "Metabolic Threshold: A1C ≥5.7% OR fasting insulin ≥12 = GLP-1 candidate"
    ],
  ...
  {
    step: "03", title: "SHBG Optimization", subtitle: "The hormone buffer system",
    color: "#6d28d9", bg: "#f5f3ff", border: "#ddd6fe",
    items: [
      "Target SHBG minimum ≥50 nmol/L; higher is better IF total hormones are adequate on HRT",
      "SHBG <30 nmol/L → suspect insulin resistance, NAFLD, visceral adiposity → metabolic workup",
      "SHBG >40 → once weekly SQ testosterone injection sufficient; SHBG <40 → twice weekly",
      "Identify SHBG-suppressors: OCPs (40–80% free T reduction), insulin resistance, obesity",
      "OCP cessation: SHBG may take 1–2 YEARS to normalize — factor into assessment",
      "Thyroid medication (especially T3) → significantly raises SHBG → may unmask low free hormones",
      "Raising SHBG: fix insulin resistance, inositol, thyroid optimization, cardiovascular exercise, dietary fiber"
    ],
    note: "[Verified] SHBG = hormone savings account. High balance (SHBG) + adequate deposits (total hormones) = optimal stability"
  },
  {
    step: "04", title: "Hormone Replacement", subtitle: "Estrogen · Progesterone · Testosterone",
    color: "#b45309", bg: "#fffbeb", border: "#fde68a",
    items: [
      "Estrogen route: Transdermal (patch/gel/cream) preferred — minimal SHBG/TBG impact, lower clot risk",
      "Oral estrogen: raises SHBG 2–4×, raises TBG → may need more thyroid hormone, increases clot risk",
      "Starting testosterone (SQ preferred): 2.5 mg testosterone cypionate SQ once weekly (SHBG ~70)",
      "Topical testosterone requires dutasteride ~0.5 mg once weekly — skin converts T→DHT at abnormally high rate",
      "Progesterone sensitivity (~10% women): try transdermal first; if still problematic consider dutasteride",
      "Virilization monitoring: acne, facial hair, voice changes (irreversible!), clitoromegaly, scalp hair loss",
      "All 3 simultaneously if DHEA-S <150; add testosterone to E+P if DHEA-S >200 after 3 months",
      "Pellets: least preferred (irreversible for 3 months, supraphysiologic risk); SubQ > IM > pellets"
    ],
  ...
  {
    step: "05", title: "DHT Management", subtitle: "Dutasteride · 5α-Reductase Inhibitors",
    color: "#be185d", bg: "#fdf2f8", border: "#fbcfe8",
    items: [
      "Candidates: SHBG <30 (shallow pool), topical testosterone users, FAGA, hirsutism, PMDD/progesterone sensitivity",
      "Dutasteride preferred over finasteride: ~98% vs ~71% DHT reduction; half-life 5 weeks vs 6 hours; no dutasteride syndrome",
      "Typical off-label dose: 0.15–0.5 mg oral, 1–3× per week (NOT daily in most women)",
      "CRITICAL: Monitor T:E ratio on dutasteride — ↓DHT = ↑estrogen sensitivity; watch for estrogen excess symptoms",
      "FAGA evidence: Boersma 2014 (n=3,500): 65.6% improvement, 83.3% ↑ hair thickness; women <50 respond better",
      "Emerging: Dutasteride mesotherapy (localized scalp injections) — blocks DHT only at follicle, avoids systemic effects",
      "ABSOLUTE CONTRAINDICATION: pregnancy; reliable contraception mandatory in reproductive-age women",
      "Also treats PMDD/PMS/postpartum via progesterone→DHP pathway — studied up to 2.5 mg/day"
    ],
    note: "[Verified] Natural DHT blockers (saw palmetto, nettles) are too weak. If a patient qualifies for these, Dr. Gillett often prefers doing nothing and optimizing SHBG instead"
  },
  {
    step: "06", title: "Body Composition & Weight", subtitle: "The 6-Punch Cascade + GLP-1 Strategy",
    color: "#b91c1c", bg: "#fff1f2", border: "#fecdd3",
    items: [
      "SWAN cohort: fat gain DOUBLES at menopause transition; lean mass DECLINES; 4-year critical window",
      "Visceral fat: +8.2%/year starting 2 years before FMP — not captured by scale weight",
      "GLP-1 candidates: HbA1c ≥5.7% OR fasting insulin ≥12 OR body fat >35% DEXA",
      "Tirzepatide preferred if: diabetic, significantly pre-diabetic, or body fat >50%",
      "MANDATORY with GLP-1: resistance training + protein ≥1.2–1.6g/kg daily (no exceptions)",
      "Maintenance semaglutide: 0.1–0.25 mg weekly; wean over 1–12 months — no rush",
      "Post-GLP-1 maintenance tools: LDN, bupropion/naltrexone, orexin inhibitors, berberine, allulose, apelyne",
      "Monitor DEXA every 6–12 months: lean mass, visceral fat, bone mineral density"
    ],
...
const EVIDENCE_CITATIONS = [
  ...
  { study: "Winters 2014", finding: "SHBG gene expression inversely related to insulin resistance; regulated by HNF4α in hepatocytes; SHBG as causal T2D risk factor.", source: "PMID 25226295; J Clin Endocrinol Metab 2014" },
  ...
  { study: "Lovejoy et al. 2008", finding: "4-year longitudinal (n=156): resting energy expenditure decreased at menopause; total daily energy expenditure fell.", source: "Int J Obes 2008 — PMC2748330" },
];

function Badge({ type }) {
  const map = {
    Verified: { bg: "#f0fdf4", color: "#15803d", border: "#bbf7d0", label: "✓ Verified" },
    Emerging: { bg: "#fffbeb", color: "#92400e", border: "#fde68a", label: "⚡ Emerging" },
    Speculation: { bg: "#f5f3ff", color: "#6d28d9", border: "#ddd6fe", label: "? Speculation" },
  };
  const s = map[type] || map.Verified;
  return <span style={{ display:"inline-flex",alignItems:"center",background:s.bg,color:s.color,padding:"1px 7px",borderRadius:"4px",fontSize:"11px",fontWeight:"700",border:`1px solid ${s.border}`,fontFamily:"'Courier New',monospace",letterSpacing:"0.02em" }}>{s.label}</span>;
}
...
function MessageBubble({ msg }) {
  ...
  return (
    <div style={{ display:"flex", justifyContent:isUser?"flex-end":"flex-start", marginBottom:"16px", gap:"10px", alignItems:"flex-start" }}>
      {!isUser && (
        <div style={{ width:"34px",height:"34px",borderRadius:"50%",background:"linear-gradient(135deg,#4f46e5,#7c3aed)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"15px",flexShrink:0,marginTop:"2px",boxShadow:"0 2px 8px rgba(79,70,229,0.25)" }}>🧬</div>
      )}
      <div style={{
        maxWidth:"82%",
        background: isUser ? "linear-gradient(135deg,#4f46e5,#6d28d9)" : "#ffffff",
        ...
        fontSize:"14px",
        lineHeight:"1.7",
        boxShadow: isUser ? "0 4px 14px rgba(79,70,229,0.2)" : "0 1px 4px rgba(0,0,0,0.06)"
      }}>
        {isUser ? msg.content : <div dangerouslySetInnerHTML={{ __html: formatContent(msg.content) }} />}
      </div>
      {isUser && (
        <div style={{ width:"34px",height:"34px",borderRadius:"50%",background:"linear-gradient(135deg,#0284c7,#0369a1)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"15px",flexShrink:0,marginTop:"2px",boxShadow:"0 2px 8px rgba(2,132,199,0.25)" }}>👤</div>
      )}
    </div>
  );
}
...
export default function HormoneAIConsultant() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#f1f5f9", fontFamily:"'Georgia','Times New Roman',serif", color:"#1e293b", display:"flex", flexDirection:"column" }}>

      {/* Header */}
      <div style={{ background:"#ffffff", borderBottom:"1px solid #e2e8f0", padding:"0 24px", display:"flex", alignItems:"center", justifyContent:"space-between", boxShadow:"0 1px 4px rgba(0,0,0,0.06)", position:"sticky", top:0, zIndex:100, height:"60px" }}>
        <div style={{ display:"flex", alignItems:"center", gap:"12px" }}>
          <div style={{ width:"38px",height:"38px",background:"linear-gradient(135deg,#4f46e5,#7c3aed)",borderRadius:"9px",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"18px",boxShadow:"0 2px 8px rgba(79,70,229,0.3)" }}>🧬</div>
          <div>
            <div style={{ fontSize:"15px",fontWeight:"700",color:"#0f172a",letterSpacing:"0.01em" }}>
              Hormone AI Consultant
              <span style={{ marginLeft:"8px",fontSize:"10px",background:"#ede9fe",color:"#6d28d9",padding:"2px 7px",borderRadius:"4px",fontFamily:"monospace",fontWeight:"700",verticalAlign:"middle" }}>v2</span>
            </div>
            <div style={{ fontSize:"10px",color:"#94a3b8",letterSpacing:"0.06em",textTransform:"uppercase",marginTop:"1px" }}>
              Women's Hormone Optimization · Dr. Kyle Gillett · PubMed Evidence Base
            </div>
          </div>
        </div>
        <div style={{ display:"flex",gap:"4px" }}>
          {[{k:"chat",label:"💬 Consult"},{k:"algorithm",label:"📋 Algorithm"},{k:"evidence",label:"📚 Evidence"}].map(v=>(
            <button key={v.k} onClick={()=>setActiveView(v.k)} style={{
              padding:"7px 14px", borderRadius:"7px", cursor:"pointer", fontFamily:"inherit", fontSize:"12px", fontWeight:"600", transition:"all 0.15s",
      ...
      <div style={{ flex:1, display:"flex", overflow:"hidden", height:"calc(100vh - 60px)" }}>
        ...
        {activeView === "chat" && (
          <>
            {/* Sidebar */}
            <div style={{ width:"215px",borderRight:"1px solid #e2e8f0",padding:"16px 12px",overflowY:"auto",background:"#ffffff",flexShrink:0 }}>
              <p style={{ fontSize:"10px",color:"#94a3b8",textTransform:"uppercase",letterSpacing:"0.1em",marginBottom:"12px",fontWeight:"700" }}>Quick Topics</p>
              {QUICK_TOPICS.map(t=>(
                <button key={t.label} onClick={()=>sendMessage(t.label)} style={{
                  width:"100%",textAlign:"left",padding:"8px 10px",background:"#f8fafc",border:"1px solid #f1f5f9",borderRadius:"7px",color:"#475569",fontSize:"11px",cursor:"pointer",marginBottom:"4px",lineHeight:"1.45",fontFamily:"inherit",transition:"all 0.15s",display:"flex",gap:"7px",alignItems:"flex-start"
                }}
            ...
            <div style={{ flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:"#f8fafc" }}>
              <div style={{ flex:1,overflowY:"auto",padding:"24px 28px" }}>
                ...
                {loading && (
                  <div style={{ display:"flex",gap:"10px",alignItems:"center",marginBottom:"16px" }}>
                    <div style={{ width:"34px",height:"34px",borderRadius:"50%",background:"linear-gradient(135deg,#4f46e5,#7c3aed)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"15px",boxShadow:"0 2px 8px rgba(79,70,229,0.25)" }}>🧬</div>
                    <div style={{ background:"#ffffff",border:"1px solid #e2e8f0",borderRadius:"4px 16px 16px 16px",padding:"11px 16px",display:"flex",gap:"5px",alignItems:"center",boxShadow:"0 1px 4px rgba(0,0,0,0.06)" }}>
              ...
              {/* Input bar */}
              <div style={{ padding:"14px 24px 16px",borderTop:"1px solid #e2e8f0",background:"#ffffff",boxShadow:"0 -1px 4px rgba(0,0,0,0.04)" }}>
                <div style={{ display:"flex",gap:"10px" }}>
                  <input value={input} onChange={e=>setInput(e.target.value)} onKeyDown={e=>e.key==="Enter"&&!e.shiftKey&&sendMessage()}
                    placeholder="Ask about testosterone dosing, SHBG targets, dutasteride protocols, GLP-1 criteria..."
                    style={{ flex:1,padding:"11px 16px",background:"#f8fafc",border:"1px solid #e2e8f0",borderRadius:"10px",color:"#1e293b",fontSize:"14px",outline:"none",fontFamily:"inherit",transition:"border-color 0.15s" }}
                    onFocus={e=>e.target.style.borderColor="#a5b4fc"}
                    onBlur={e=>e.target.style.borderColor="#e2e8f0"}
                  />
                  <button onClick={()=>sendMessage()} disabled={loading||!input.trim()} style={{
                    padding:"11px 20px",background:loading||!input.trim()?"#e2e8f0":"linear-gradient(135deg,#4f46e5,#7c3aed)",border:"none",borderRadius:"10px",
                    color:loading||!input.trim()?"#94a3b8":"#ffffff",fontSize:"14px",cursor:loading||!input.trim()?"not-allowed":"pointer",
                    fontFamily:"inherit",fontWeight:"700",boxShadow:loading||!input.trim()?"none":"0 3px 12px rgba(79,70,229,0.3)",transition:"all 0.2s"
                  }}>{loading?"...":"Send →"}</button>
                </div>
                <p style={{ color:"#cbd5e1",fontSize:"10px",marginTop:"8px",textAlign:"center",letterSpacing:"0.03em" }}>
                  Educational only · Not medical advice · Always consult a qualified hormone specialist
                </p>
              </div>
            </div>
          </>
        ...
        {activeView === "algorithm" && (
          <div style={{ flex:1,display:"flex",overflow:"hidden" }}>
            ...
            <div style={{ width:"195px",borderRight:"1px solid #e2e8f0",padding:"16px 12px",background:"#ffffff",overflowY:"auto" }}>
              ...
              {ALGORITHM_STEPS.map((s,i)=>(
                <button key={i} onClick={()=>setActiveStep(i)} style={{
                  width:"100%",textAlign:"left",padding:"10px 12px",marginBottom:"4px",cursor:"pointer",fontFamily:"inherit",transition:"all 0.15s",borderRadius:"8px",
                  background: activeStep===i ? s.bg : "transparent",
                  border: activeStep===i ? `1px solid ${s.border}` : "1px solid transparent",
                }}>
            ...
            <div style={{ flex:1,padding:"28px 32px",overflowY:"auto",background:"#f8fafc" }}>
              <div style={{ background:"#ffffff",border:`1px solid ${step.border}`,borderRadius:"14px",padding:"26px",marginBottom:"16px",boxShadow:"0 2px 8px rgba(0,0,0,0.05)" }}>
                ...
                <div style={{ marginTop:"16px",padding:"12px 14px",background:"#f8fafc",border:"1px solid #e2e8f0",borderLeft:`3px solid ${step.color}`,borderRadius:"6px",fontSize:"12px",color:"#475569",fontStyle:"italic",lineHeight:"1.5" }}>
                  💡 {step.note}
                </div>
              </div>
              <div style={{ display:"flex",gap:"10px",justifyContent:"space-between" }}>
                <button onClick={()=>setActiveStep(Math.max(0,activeStep-1))} disabled={activeStep===0} style={{ padding:"9px 18px",background:"#ffffff",border:"1px solid #e2e8f0",borderRadius:"8px",color:activeStep===0?"#cbd5e1":"#475569",cursor:activeStep===0?"not-allowed":"pointer",fontFamily:"inherit",fontSize:"13px",fontWeight:"600",boxShadow:"0 1px 3px rgba(0,0,0,0.05)" }}>← Previous</button>
                ...
                <button onClick={()=>setActiveStep(Math.min(ALGORITHM_STEPS.length-1,activeStep+1))} disabled={activeStep===ALGORITHM_STEPS.length-1} style={{ padding:"9px 18px",background:"#ffffff",border:"1px solid #e2e8f0",borderRadius:"8px",color:activeStep===ALGORITHM_STEPS.length-1?"#cbd5e1":"#475569",cursor:activeStep===ALGORITHM_STEPS.length-1?"not-allowed":"pointer",fontFamily:"inherit",fontSize:"13px",fontWeight:"600",boxShadow:"0 1px 3px rgba(0,0,0,0.05)" }}>Next →</button>
              </div>
            </div>
          </div>
        )}
        ...
        {activeView === "evidence" && (
          <div style={{ flex:1,overflowY:"auto",padding:"28px 32px",background:"#f8fafc" }}>
            <div style={{ marginBottom:"24px" }}>
              <h2 style={{ color:"#0f172a",fontSize:"18px",fontWeight:"700",marginBottom:"4px" }}>Evidence Base</h2>
            ...
            <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:"14px",marginBottom:"24px" }}>
              {EVIDENCE_CITATIONS.map((c,i)=>(
                <div key={i} style={{ background:"#ffffff",border:"1px solid #e2e8f0",borderRadius:"10px",padding:"16px",boxShadow:"0 1px 4px rgba(0,0,0,0.04)" }}>
                  <div style={{ color:"#4338ca",fontSize:"13px",fontWeight:"700",marginBottom:"6px" }}>{c.study}</div>
                  <div style={{ color:"#475569",fontSize:"12px",lineHeight:"1.6",marginBottom:"10px" }}>{c.finding}</div>
                  <div style={{ color:"#94a3b8",fontSize:"10px",fontFamily:"monospace",background:"#f8fafc",padding:"4px 8px",borderRadius:"5px",border:"1px solid #e2e8f0" }}>{c.source}</div>
                </div>
              ))}
            </div>
            <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:"14px" }}>
              {[
                ...
                <div key={col.title} style={{ background:"#ffffff",border:`1px solid ${col.border}`,borderRadius:"10px",padding:"16px",boxShadow:"0 1px 4px rgba(0,0,0,0.04)" }}>
                  <h4 style={{ color:col.color,fontSize:"13px",marginBottom:"12px",fontWeight:"700",paddingBottom:"8px",borderBottom:`1px solid ${col.border}` }}>{col.title}</h4>
                  {col.items.map(item=>(
                    <div key={item} style={{ color:"#475569",fontSize:"12px",padding:"5px 0",borderBottom:`1px solid ${col.border}`,display:"flex",gap:"7px",alignItems:"flex-start" }}>
